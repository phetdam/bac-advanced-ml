...
\begin{frame}{Random variables}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \mathbb{I}\{\omega = \text{H}\} - q_2
            \mathbb{I}\{\omega = \text{T}\} $. $ \mathbb{I} $ is the indicator
            function, yielding $ 1 $ when its argument is true and $ 0 $
            otherwise. $ X(\Omega) = \{-q_2, q_1\} $.
        \end{itemize}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{equation*}
            \begin{aligned}
                ...
                \mathbb{E}[\mathbb{I}\{X \in A\}] & = \mathbb{P}\{X \in A\}
            \end{aligned}
        \end{equation*}
