...
\begin{frame}{Proximal gradient descent}
    \begin{itemize}
        ...
        \item
        One possible\footnote{
            \cite{prox_algos} provides alternative interpretations of
...
\begin{frame}{Proximal gradient descent}
    \begin{itemize}
        \item
        Using $ \hat{f}_{\eta_t} $ from (\aref{eq:prox_grad_mm_func}), the
        majorization-minimization update is actually identical\footnote{
