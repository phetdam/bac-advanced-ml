...
can be more clearly seen if $ \mathcal{L}_f $ if the inequality constraints
...
%        \displaystyle-\frac{1}{4}\lambda^\top\begin{bmatrix}
%            -\mathbf{I} \ \\ \phantom{-} \mathbf{I} \ \\
%            \ \ -\mathbf{1}^\top \ \\ \ \ \phantom{-} \mathbf{1}^\top \
%        \end{bmatrix}\mathbf{C}^{-1}\begin{bmatrix}
%            \ -\mathbf{I} & \mathbf{I} & -\mathbf{1} & \mathbf{1} \
%        \end{bmatrix}\lambda + \displaystyle\lambda^\top\begin{bmatrix}
%            \ \mathbf{0} \ \\ -\gamma\mathbf{1} \ \\ \ 0 \ \\ -(1 - \kappa) \
%        \end{bmatrix} \\
