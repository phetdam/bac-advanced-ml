...
\begin{frame}{Karush-Kun-Tucker conditions}
    \begin{itemize}
        \item
...
\begin{frame}{Karush-Kuhn-Tucker conditions}
    \begin{itemize}
        \item
        KKT conditions are \alert{necessary} optimality conditions for general
        optimization problems with differentiable objective and constraints.
