...
\begin{frame}{Primal formulation}
    \begin{itemize}
        ...
        $ \mathbf{1}^\top\xi \le K $ constraint has been relaxed.
        ...
        \item
        We prefer (\aref{eq:linear_svc_primal}) to
        (\aref{eq:linear_svc_nonsep}), as reducing hard constraints is
        desirable from a computing perspective \cite{esl}.
    \end{itemize}
\end{frame}
